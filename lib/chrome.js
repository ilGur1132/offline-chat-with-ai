...
app.button = {
  ...
  "set": {
    "popup": function (e, callback) {
      chrome.action.setPopup({"popup": e}, function (e) {
        if (callback) callback(e);
      });
    },
    "sidebar": async function (e, callback) {
      if (chrome.sidePanel) {
        if (e) {
          if (typeof e === "object") {
            chrome.sidePanel.setOptions(e, function () {
              chrome.sidePanel.setPanelBehavior({"openPanelOnActionClick": true}, function () {
                if (callback) callback(true);
              });
            });
          } else {
            chrome.sidePanel.setOptions({"path": e, "enabled": true}, function () {
              chrome.sidePanel.setPanelBehavior({"openPanelOnActionClick": true}, function () {
                if (callback) callback(true);
              });
            });
          ...
          chrome.sidePanel.setOptions({"enabled": false}, function () {
            if (callback) callback(true);
          });
        }
      }
